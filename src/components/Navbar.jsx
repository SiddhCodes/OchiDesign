const Navbar = () => {
  return (
    <div className="flex items-center justify-between p-5 lg:px-15 lg:py-5 fixed z-[999] w-full">
      <div className="logo">
        <svg
          width="72"
          height="30"
      ...
      <div className="links hidden lg:flex lg:gap-7">
        {["Services", "Our work", "About us", "Insights", "Contact us"].map(
          (e, i) => {
            return (
              <a
                key={i}
                className={`font-[NeueMontreal] ${i === 4 && "lg:ml-70"}`}
              >
                {e}
              </a>
            );
